...
namespace AM.ApplicationCore.Domain
{
    public static class TestData
    {
        ...
        {
            PlanType = planeType.Boing,
            Capacity =150,
            ManufactureDate = new DateTime(2015, 02, 03)
        };
        public static Plane Airbusplane = new Plane
        {
            PlanType = planeType.Airbus,
            Capacity =250,
...
traveller3, traveller4, traveller5 }
        ,
            Plane = Airbusplane
        };
        public static Flight flight2 = new Flight
        {
            FlightDate = new DateTime(2022, 02, 01, 21, 10,
        10),
            Destination = "Paris",
        ...
        {
            FlightDate = new DateTime(2022, 03, 01, 5, 10,
        10),
            Destination = "Paris",
        ...
        {
            FlightDate = new DateTime(2022, 04, 01, 6, 10,
        10),
            Destination = "Madrid",
        ...
        {
            FlightDate = new DateTime(2022, 05, 01, 17, 10,
        10),
            Destination = "Madrid",
        ...
        {
            FlightDate = new DateTime(2022, 06, 01, 20, 10,
        10),
        ...
        //test list
        public static List<Flight> listFlights = new List<Flight> { flight1, flight2, flight3, flight4, flight5,
flight6 };
    }
}
